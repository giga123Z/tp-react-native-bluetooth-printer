...
Chắc năng:
  + Hỗ trợ tìm bluetooth device tốt hơn các lib khác
  + Đã custom để tạo ra buffer ảnh in sắc nét, làm đầu vào cho thư viện NetPrinter
  + Hỗ trợ hàm disconnect bluetooth trong ios
## Installation
